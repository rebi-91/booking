...
function StudentForm() {
  ...
  const [activeContainer, setActiveContainer] = useState<string | null>(null); // 'filters' or 'add'
  ...
  const fetchStudents = async (className: string, section: string) => {
    try {
      setIsLoading(true);
      const { data, error } = await supabase
        .from("student")
      ...
      const mappedStudents = (data as any[]).map((item) => ({
        id: item.id,
  ...
  const handleAddStudent = async () => {
    ...
    try {
      ...
      // Shift IDs for all students with ID >= newId
      ...
      const shiftingPromises = (shiftingData as any[]).map((student) =>
        supabase
          .from("student")
      ...
      >
        ...
        <div
          style={{
            ...
            minWidth: "280px",
            opacity:
              activeContainer === "filters" || activeContainer === null ? 1 : 0.6,
          }}
        ...
        >
          ...
          <div style={{ marginBottom: "15px", display: "flex", flexDirection: "column" as const }}>
            <label style={{ marginBottom: "5px", fontWeight: "500", color: "#333" }}>Class:</label>
            <select
              style={{
                padding: "10px",
                fontSize: "16px",
          ...
          {selectedClassName && (
            <div style={{ marginBottom: "15px", display: "flex", flexDirection: "column" as const }}>
              <label style={{ marginBottom: "5px", fontWeight: "500", color: "#333" }}>Section:</label>
              <select
                style={{
                  padding: "10px",
                  fontSize: "16px",
        ...
        <div
          style={{
            ...
            minWidth: "280px",
            opacity:
              activeContainer === "add" || activeContainer === null ? 1 : 0.6,
          }}
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column" as const, gap: "15px" }}>
            <div style={{ display: "flex", flexDirection: "column" as const, marginBottom: "15px" }}>
              <label style={{ marginBottom: "5px", fontWeight: "500", color: "#333" }}>Name:</label>
              <input
                type="text"
                ...
                <tbody>
                  {filteredStudents.length > 0 ? (
                    ...
                    <tr>
                      <td
                        colSpan={8}
                        style={{ textAlign: "center" as const, padding: "20px", color: "#777" }}
                      >
                        No students found.
                      </td>
                    </tr>
