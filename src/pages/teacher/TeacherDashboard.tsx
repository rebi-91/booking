...
const TeacherDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      if (!selectedClass || !selectedSection || !studentSheetName || !userSchool) return;
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        {/* Dropdowns Container */}
        <div className={`dropdown-container ${isDropdownsMinimized ? 'minimized' : ''}`}>
              ...
              students.map((student) => (
                <div key={student.id} className="student-container">
                  ...
                  <div style={{ width: '100%' }}>
                    <input
                      type="text"
                      className={`mark-field ${validationErrors[student.id] ? 'invalid' : ''}`}
