...
//         .container {
//           padding: 120px 60px 60px 60px; /* Adjusted padding to account for fixed header */
//           max-width: 900px;
//           margin: 0 auto;
//         }
...
//         /* Save Ratios Button Specific Styles */
//         #saveRatiosButton {
//           padding: 10px 20px;
//           background-color: #0D2F7A;
//           border: 2px solid #0C2A6E;
...
//           <div id="studentList" className="student-list">
//             {loadingStudents ? (
