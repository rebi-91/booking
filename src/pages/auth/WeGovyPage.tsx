    ...
    <>
      ...
      <main className="pt-header">
          ...
          <div className="pricing-list">
            <div className="pricing-card">
              ...
              <p className="product-sub">
                1 Injection (4 weeks supply) — <strong>£159.00</strong>
              </p>
            </div>
            <div className="pricing-card">
            ...
            <div className="pricing-card">
              ...
              <p className="product-sub">
                1 Injection (4 weeks supply) — <strong>£209.00</strong>
              </p>
            </div>
            <div className="pricing-card">
              <h3 className="product-title">Wegovy 2.4mg</h3>
              <p className="product-sub">
                1 Injection (4 weeks supply) — <strong>£263.00</strong>
              </p>
            </div>
          </div>
        </section>
        ...
        {/* ===============================
           ...
           =============================== */}
        <section className="container about-section">
          <h2 className="section-heading">Wegovy Overview</h2>
          <p className="section-subtext">
        ...
        {/* <section className="container intro-section">
          ...
          <p className="section-subtext">
            In the heart of Coleshill, we provide quality NHS and private health services.
            Explore our treatments or consult our medical professionals.
          </p>
          <p className="section-subtext">
            <strong>Phone:</strong> 01634 404142 <br />
            <strong>Email:</strong> pharmacy.fe813@nhs.net <br />
            <strong>Address:</strong> 139 NEW ROAD, Coleshill, GB, ME4 4PT
          </p>
          <p className="section-subtext">
            <strong>Open Hours:</strong> <br />
            Monday – Friday: 09:00 – 18:15<br />
