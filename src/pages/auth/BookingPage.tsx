...
//     address: '114–116 High St, Coleshill, Birmingham B46 3BJ',
//     price:
//       'Our service is £40 for one ear and £50 for two ears. £10 consult fee if no wax removed.',
//   },
//   20: {
//     id: 20,
...
//     slots.push(`${hh}:${mm}`);
//     current = new Date(current.getTime() + stepMins * 60000);
//   }
//   return slots;
// }

// function slotsForDayAndCategory(dayIndex: number, category: Category): string[] {
//   const step = category === 'Private' ? 20 : 10;
...
//                   {/* ← duration now derived inline based on category */}
//                   <div className="info-item">
//                     <i className="bi bi-clock"></i>
//                     <span>{category === 'Private' ? '20m' : '10m'}</span>
//                   </div>
//                   <div className="info-item">
...
//                     )}
//                   </span>
//                   <button className="btn header-arrow" onClick={handleNextMonth}>
//                     ›
//                   </button>
//                 </div>
...
//                     else if (isToday) dayClass = 'today-day';

//                     return (
//                       <div key={day} className="col-1 px-0">
//                         <button
//                           onClick={() => !dateInPast && handleDayClick(day)}
//                           className={`btn day-btn ${dateInPast ? 'past-day' : dayClass}`}
//                           disabled={dateInPast}
//                         >
//                           {day}
//                         </button>
...
//                             <button
//                               className={`btn time-slot-btn ${isChosen ? 'selected-time' : ''}`}
