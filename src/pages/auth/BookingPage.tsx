...
//     address: '114–116 High St, Coleshill, Birmingham B46 3BJ',
//     price: '£55 for one ear £75 for both. (£25 for consultation if no wax is found) <br/><b>Please ensure you have been using olive oil twice a day for at least 14 days prior to appointment.</b>'
//   },
...
function isWithinDateRange(date: Date, start: Date, end: Date): boolean {
...
function slotsForDayAndCategory(
  ...
  // ✅ Ear wax removal rules
  // Removed old Wednesday-only rule.
  // Now:
  // - No Saturdays
  // - No Sundays
  // - No booking from 18 May 2026 for 4 weeks
  if (sid === 18 && date) {
    const earWaxBlockStart = new Date(2026, 4, 18); // 18 May 2026
    const earWaxBlockEnd = new Date(2026, 5, 14); // 14 June 2026

    if (dow === 6) {
      return []; // no Saturdays
    }

    if (isWithinDateRange(date, earWaxBlockStart, earWaxBlockEnd)) {
      return []; // blocked for 4 weeks from 18 May 2026
    }
            ...
            <>
              ...
              <div className="service-header">
                ...
                <p className="booking-subtitle">
                  {sid === 14 && (
                    <>
                      Flu vaccinations are available from 2nd October 2026.
                      <div className="mt-2 texxt">
                        <div className="mt-2">Flu Eligible Patients:</div>
                        <ul className="list-disc list-inside">
                          <li>Aged 65 and over</li>
                ...
                <div className="calendar-grid">
                  ...
                  {Array.from({ length: daysInMonth }, (_, i) => i + 1).map(
                    (day) => {
                      ...
                      // Ear wax removal restrictions
                      if (sid === 18) {
                        const dow = dObj.getDay();
                        const earWaxBlockStart = new Date(2026, 4, 18);
                        const earWaxBlockEnd = new Date(2026, 5, 14);
